...
suspend:
    ...
    neon_maintanance.py --port 8092 suspend\n\n

resume:

    neon_maintanance.py --host localhost --port 9092 resume

replicate:

    python3 neon_maintanance.py replicate proxy-replica proxy-replica:9092
