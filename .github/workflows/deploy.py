...
def cleanup_docker():
    subprocess.run("docker stop $(docker ps -a -q)", shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    subprocess.run("docker rm $(docker ps -a -q)", shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
