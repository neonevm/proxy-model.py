...
class TestNeonTxSender(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.testee = NeonTxSender(MemDB(cls.solana), cls.solana, trx, 500)
        cls.testee._validate_pend_tx = Mock()
        cls.testee._validate_whitelist = Mock()
        cls.testee._validate_tx_count = Mock()
        cls.testee._resource_list._min_operator_balance_to_warn = Mock()
        cls.testee._resource_list._min_operator_balance_to_err = Mock()
    ...
    # @unittest.skip("a.i.")
    def test_validate_execution_when_not_enough_sols(self):
        """
