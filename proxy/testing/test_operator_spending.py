...
class TransactonCost(unittest.TestCase):
    ...
    def test_deploy_cost(self):
        ...
        balance_pre = int(self.client.get_balance(self.acc.pubkey(), commitment=Confirmed).value)
        ...
        balance_post = int(self.client.get_balance(self.acc.pubkey(), commitment=Confirmed).value)
