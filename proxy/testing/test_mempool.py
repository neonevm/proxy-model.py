...
class Test(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_single_sender_txs(self, submit_mp_request_mock: MagicMock):
        neon_tx = NeonTx.fromString(bytearray.fromhex(
            'f8678080843ade68b194f0dafe87532d4373453b2555c644390e1b99e84c8459682f0080820102a00193e1966a82c5597942370980'
            'fb78080901ca86eb3c1b25ec600b2760cfcc94a03efcc1169e161f9a148fd4586e0bcf880648ca74075bfa7a9acc8800614fc9ff'))

        tx_cfg = NeonTxExecCfg(is_underpriced_tx_without_chainid=False, steps_executed=100)
        mp_tx_request = MPTxRequest(req_id="test_rq_1", signature="asdf", neon_tx=neon_tx, neon_tx_exec_cfg=tx_cfg,
