...
NEON_MINIMAL_CLIENT_ALLOWANCE_BALANCE = ELF_PARAMS.get("NEON_MINIMAL_CLIENT_ALLOWANCE_BALANCE", None)
NEON_MINIMAL_CONTRACT_ALLOWANCE_BALANCE = ELF_PARAMS.get("NEON_MINIMAL_CONTRACT_ALLOWANCE_BALANCE", None)
