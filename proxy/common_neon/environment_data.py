...
RECHECK_USED_RESOURCE_SEC = int(os.environ.get('RECHECK_USED_RESOURCE_SEC', 60))
RECHECK_RESOURCE_AFTER_USES_CNT = int(os.environ.get("RECHECK_RESOURCE_AFTER_USES_CNT", 60))
