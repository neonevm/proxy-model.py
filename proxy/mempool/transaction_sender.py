...
class AccountTxListBuilder:
    ...
    def _build_account_stage_list(self) -> None:
        ...
        size_list = list(set([s.size for s in self._create_account_stage_list]))
        ...
        for s in self._create_account_stage_list:
    ...
    def get_tx_list_info(self) -> SolTxListInfo:
        return SolTxListInfo(
            name_list=[s.NAME for s in self._create_account_stage_list],
            tx_list=[s.tx for s in self._create_account_stage_list]
        )
...
class NeonTxSendCtx:
    def __init__(self, solana: SolanaInteractor, resource: OperatorResourceInfo, neon_tx: NeonTx):
        ...
        self._emulated_additional_resize_steps = False
    ...
    @property
    def emulated_additional_resize_steps(self) -> bool:
        return self._emulated_additional_resize_steps

    def set_emulated_additional_resize_steps(self, value: bool):
        self._emulated_additional_resize_steps = value
...
class SimpleNeonTxStrategy(BaseNeonTxStrategy):
    ...
    def _validate_no_additional_resize_steps(self) -> bool:
        return not self._ctx.emulated_additional_resize_steps
...
class NeonTxSendStrategyExecutor:
    ...
    def _init_emulated_cfg(self, neon_tx_exec_cfg: NeonTxExecCfg) -> None:
        ...
        self._ctx.set_emulated_additional_resize_steps(neon_tx_exec_cfg.additional_resize_steps)
