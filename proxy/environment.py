...
MULTIPLIER_FOR_REQUIRED_SOLS = max(int(os.environ.get("MULTIPLIER_FOR_REQUIRED_SOLS", 1)), 1)
MIN_OPERATOR_BALANCE_TO_WARN = max(int(os.environ.get("MIN_OPERATOR_BALANCE_TO_WARN", 1000000)), 1000000)
