...
NEON_COMPUTE_UNITS = ELF_PARAMS.get('NEON_COMPUTE_UNITS')
NEON_HEAP_FRAME = ELF_PARAMS.get('NEON_HEAP_FRAME')
NEON_ADDITIONAL_FEE = ELF_PARAMS.get('NEON_ADDITIONAL_FEE')
