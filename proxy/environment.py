...
NEON_PERMISSION_ALLOWANCE_TOKEN = ELF_PARAMS.get("NEON_PERMISSION_ALLOWANCE_TOKEN", '')
if NEON_PERMISSION_ALLOWANCE_TOKEN != '':
    NEON_PERMISSION_ALLOWANCE_TOKEN = PublicKey(NEON_PERMISSION_ALLOWANCE_TOKEN)

NEON_PERMISSION_DENIAL_TOKEN = ELF_PARAMS.get("NEON_PERMISSION_DENIAL_TOKEN", '')
if NEON_PERMISSION_DENIAL_TOKEN != '':
    NEON_PERMISSION_DENIAL_TOKEN = PublicKey(NEON_PERMISSION_DENIAL_TOKEN)
