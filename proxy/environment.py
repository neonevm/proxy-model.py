...
NEON_CONTRACT_ALLOWANCE_TOKEN = ELF_PARAMS.get("NEON_CONTRACT_ALLOWANCE_TOKEN", None)
if NEON_CONTRACT_ALLOWANCE_TOKEN is not None:
    NEON_CONTRACT_ALLOWANCE_TOKEN = PublicKey(NEON_CONTRACT_ALLOWANCE_TOKEN)

NEON_CLIENT_DENIAL_TOKEN = ELF_PARAMS.get("NEON_CLIENT_DENIAL_TOKEN", None)
if NEON_CLIENT_DENIAL_TOKEN is not None:
    NEON_CLIENT_DENIAL_TOKEN = PublicKey(NEON_CLIENT_DENIAL_TOKEN)

NEON_CONTRACT_DENIAL_TOKEN = ELF_PARAMS.get("NEON_CONTRACT_DENIAL_TOKEN", None)
if NEON_CONTRACT_DENIAL_TOKEN is not None:
    NEON_CONTRACT_DENIAL_TOKEN = PublicKey(NEON_CONTRACT_DENIAL_TOKEN)
